...
Template.about.events({
    'change #file': function (event) {
        ...
        Meteor.call('uploadVideo', event.target.files[0], function (error, result) {
            if(error){
                console.error(error)
            }
            console.log(result);
...
function youtubeAPI(access_token){
...
UploadVideo.prototype.ready = function(accessToken) {
  // gapi.client.setApiKey("AIzaSyC58RX7rK2CMT-fceZoTSNtA5NS21fRkTw");
